...
namespace Furball.Engine.Engine.Graphics.PostProcessEffects {
    /// <summary>
    ///
    ...
    public class BloomRenderer {
        ...
        public void Load(
            GraphicsDevice graphicsDevice, ContentManager content, int width, int height, SurfaceFormat renderTargetFormat = SurfaceFormat.Color,
        ...
        public Texture2D Draw(Texture2D inputTexture) {
            ...
            if (this._resolutionUpdated) {
                //Adjust the blur so it looks consistent across diferrent scalings
                _radiusMultiplier = (float) this._width / inputTexture.Width;
        ...
        private bool _resolutionUpdated = true;
