...
namespace Furball.Engine.Engine.Renderers {
    ...
    public class QuadRenderer
    {
        ...
        public QuadRenderer(GraphicsDevice graphicsDevice)
        {
            ...
            this._indexBuffer = new short[] { 0, 3, 2, 0, 1, 3 };
        ...
        {
            this._vertexBuffer[0].Position.X = v1.X;
            this._vertexBuffer[0].Position.Y    = v2.Y;

            this._vertexBuffer[1].Position.X = v2.X;
            this._vertexBuffer[1].Position.Y    = v2.Y;

            this._vertexBuffer[2].Position.X = v1.X;
            this._vertexBuffer[2].Position.Y    = v1.Y;

            this._vertexBuffer[3].Position.X = v2.X;
            this._vertexBuffer[3].Position.Y    = v1.Y;

            graphicsDevice.DrawUserIndexedPrimitives
                (PrimitiveType.TriangleList, this._vertexBuffer, 0, 4, this._indexBuffer, 0, 2);
